...
#[AsCommand(name: 'config:view', description: 'Show the resolved configuration after merging all sources')]
final class ConfigViewCommand extends AbstractPleadCommand
{
