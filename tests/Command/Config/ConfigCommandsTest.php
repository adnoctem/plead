...
final class ConfigCommandsTest extends TestCase
{
    ...
    {
        $this->tester->run(['command' => 'config:set', 'key' => 'plesk.host', 'value' => 'mail.company.com']);
        self::assertSame(0, $this->tester->getStatusCode());

        $this->tester->run(['command' => 'config:set', 'key' => 'plesk.secret_key', 'value' => 's3cret']);
        self::assertSame(0, $this->tester->getStatusCode());

        $this->tester->run(['command' => 'config:get', 'key' => 'plesk.host']);
        self::assertSame(0, $this->tester->getStatusCode());
    ...
    {
        $this->tester->run(['command' => 'config:set', 'key' => 'plesk.host', 'value' => 'file.example.com']);
        $this->tester->run(['command' => 'config:set', 'key' => 'plesk.secret_key', 'value' => 'file-secret']);
        ...
        self::assertSame(0, $this->tester->getStatusCode());
        self::assertStringContainsString('env.example.com', $this->tester->getDisplay());
